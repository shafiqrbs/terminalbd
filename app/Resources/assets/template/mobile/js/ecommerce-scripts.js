            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.has_error) {
                        ...
                        setTimeout(function () {
                           $("#login-footer").html('<button type="submit"  class="btn btn-warning col-xs-12 col-md-12"><span class="glyphicon glyphicon-cart"></span> Take Order <span class="glyphicon glyphicon-play"></span></button>');
                           $("#login-cart").html(' <span class="dd-span pull-right"><button  type="submit" class="btn btn-success">Take Order <span class="glyphicon glyphicon-play"></span></button></span>');
