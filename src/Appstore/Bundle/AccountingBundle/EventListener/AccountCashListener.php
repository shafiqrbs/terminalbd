...
class AccountCashListener
{
    ...
    public function createCode(LifecycleEventArgs $args)
    {
        ...
        if ($entity instanceof AccountCash) {
            ...
            $entity->setAccountRefNo(sprintf("%s%s", $datetime->format('my'), str_pad($entity->getCode(),6, '0', STR_PAD_LEFT)));
        }
    }
    ...
    public function getLastCode(LifecycleEventArgs $args, $datetime, $entity)
    {
        ...
        $qb = $entityManager->getRepository('AccountingBundle:AccountCash')->createQueryBuilder('s');
