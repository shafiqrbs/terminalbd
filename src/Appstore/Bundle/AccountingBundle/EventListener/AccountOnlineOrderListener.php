...
class AccountOnlineOrderListener
{
    ...
    public function createCode(LifecycleEventArgs $args)
    {
        ...
        if ($entity instanceof AccountOnlineOrder) {
    ...
    public function getLastCode(LifecycleEventArgs $args, $datetime, $entity)
    {
        ...
        $qb = $entityManager->getRepository('AccountingBundle:AccountOnlineOrder')->createQueryBuilder('s');
