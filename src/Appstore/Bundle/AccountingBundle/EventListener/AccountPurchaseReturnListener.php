...
class AccountPurchaseReturnListener
{
    ...
    public function createCode(LifecycleEventArgs $args)
    {
        ...
        if ($entity instanceof AccountPurchaseReturn) {
    ...
    public function getLastCode(LifecycleEventArgs $args, $datetime, $entity)
    {
        ...
        $qb = $entityManager->getRepository('AccountingBundle:AccountPurchaseReturn')->createQueryBuilder('s');
        $qb
            ->select('MAX(s.code)')
