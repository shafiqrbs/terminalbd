...
class AccountSalesReturnListener
{
    ...
    public function createCode(LifecycleEventArgs $args)
    {
        ...
        if ($entity instanceof AccountSalesReturn) {
    ...
    public function getLastCode(LifecycleEventArgs $args, $datetime, $entity)
    {
        ...
        $qb = $entityManager->getRepository('AccountingBundle:AccountSalesReturn')->createQueryBuilder('s');
        $qb
            ->select('MAX(s.code)')
