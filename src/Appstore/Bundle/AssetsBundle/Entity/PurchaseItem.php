 ...
 * VoucherItem
 *
 * @ORM\Table(name ="assets_purchase_item")
 * @ORM\Entity(repositoryClass="Appstore\Bundle\AssetsBundle\Repository\PurchaseItemRepository")
 */
class PurchaseItem
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Appstore\Bundle\AssetsBundle\Entity\Purchase", inversedBy="purchaseItems" )
     * @ORM\JoinColumn(onDelete="CASCADE")
     **/
