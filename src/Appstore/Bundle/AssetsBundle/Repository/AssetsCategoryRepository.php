 ...
 */
class AssetsCategoryRepository extends MaterializedPathRepository
{
    ...
    public function build_child($oldID,$array)
    {
        ...
        $childData = $em->getRepository('AssetsBundle:AssetsCategory')->findBy(array('parent'=>$oldID),array('name'=>'asc'));
    ...
    public function getCategoryOptions($globalOption){
        ...
        $ret = array();
        $em = $this->_em;
        $categories = $em->getRepository('AssetsBundle:AssetsCategory')->findBy(array('globalOption' => $globalOption ,'status' => 1),array('name'=>'asc'));
