...
class ExpenseCategoryController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('BusinessBundle:ExpenseCategory:index.html.twig', array(
            'entities' => $pagination,
        ));
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('BusinessBundle:ExpenseCategory:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        return $this->render('BusinessBundle:ExpenseCategory:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        return $this->render('BusinessBundle:ExpenseCategory:edit.html.twig', array(
            'entity'      => $entity,
