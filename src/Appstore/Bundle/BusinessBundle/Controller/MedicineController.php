...
use Appstore\Bundle\BusinessBundle\Form\MedicineType;
...
class MedicineController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $this->getDoctrine()->getRepository('BusinessBundle:BusinessParticular')->getMedicineParticular($config,array('accessories'));
        $pagination = $this->paginate($entities);
        $entity = new BusinessParticular();
        $form = $this->createCreateForm($entity);
        return $this->render('BusinessBundle:Medicine:index.html.twig', array(
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            $service = $this->getDoctrine()->getRepository('BusinessBundle:BusinessService')->findOneBy(array('slug'=>'accessories'));
