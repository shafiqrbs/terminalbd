...
class BusinessPurchaseListener
{
    ...
    public function createCode(LifecycleEventArgs $args)
    {
        ...
        if ($entity instanceof BusinessPurchase) {
    ...
    public function getLastCode(LifecycleEventArgs $args, $datetime, $entity)
    {
        ...
        $qb = $entityManager->getRepository('BusinessBundle:BusinessPurchase')->createQueryBuilder('s');
