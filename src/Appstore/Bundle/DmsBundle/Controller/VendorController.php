...
class VendorController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $this->getDoctrine()->getRepository('DmsBundle:DmsVendor')->findBy(array('dmsConfig' => $hospital),array('companyName'=>'ASC'));
    ...
    public function editAction($id)
    {
        ...
        $entity = $em->getRepository('DmsBundle:DmsVendor')->find($id);
    ...
    */
    ...
    public function autoSearchAction(Request $request)
    {
        ...
        if ($item) {
            ...
            $item = $this->getDoctrine()->getRepository('DmsBundle:DmsVendor')->searchAutoComplete($item,$inventory);
        }
