 ...
 * Invoice
 *
 * @ORM\Table( name ="dms_invoice_transaction")
 * @ORM\Entity(repositoryClass="Appstore\Bundle\DmsBundle\Repository\DmsInvoiceTransactionRepository")
 */
class DmsInvoiceTransaction
{
    /**
     * @var integer
     *
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Appstore\Bundle\DmsBundle\Entity\DmsInvoice", inversedBy="invoiceTransactions")
