...
use Appstore\Bundle\DoctorPrescriptionBundle\Form\MedicineType;
...
class MedicineController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $this->getDoctrine()->getRepository('DoctorPrescriptionBundle:DpsParticular')->getMedicineParticular($config,array('accessories'));
        $pagination = $this->paginate($entities);
        $entity = new DmsParticular();
        $form = $this->createCreateForm($entity);
        return $this->render('DoctorPrescriptionBundle:Medicine:index.html.twig', array(
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            $service = $this->getDoctrine()->getRepository('DoctorPrescriptionBundle:DpsService')->findOneBy(array('slug'=>'accessories'));
            ...
            return $this->redirect($this->generateUrl('dps_medicine'));
        }
        return $this->render('DoctorPrescriptionBundle:Medicine:index.html.twig', array(
            'entity' => $entity,
            'pagination' => $pagination,
    ...
    private function createCreateForm(DmsParticular $entity)
    {
        ...
        $form = $this->createForm(new MedicineType(), $entity, array(
            'action' => $this->generateUrl('dps_medicine_create', array('id' => $entity->getId())),
            'method' => 'POST',
            'attr' => array(
    ...
    {
        $form = $this->createForm(new MedicineType(), $entity, array(
            'action' => $this->generateUrl('dps_medicine_update', array('id' => $entity->getId())),
            'method' => 'PUT',
            'attr' => array(
                'class' => 'horizontal-form',
                'novalidate' => 'novalidate',
    ...
    public function inlineUpdateAction(Request $request)
    {
        ...
        $em = $this->getDoctrine()->getManager();
        $entity = $em->getRepository('DoctorPrescriptionBundle:DpsParticular')->find($data['pk']);
        if (!$entity) {
