...
use Appstore\Bundle\DoctorPrescriptionBundle\Form\TreatmentType;
...
class TreatmentController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $pagination = $em->getRepository('DoctorPrescriptionBundle:DpsParticular')->getFindDentalServiceParticular($config,array('treatment'));
        $form = $this->createCreateForm($entity);
        return $this->render('DoctorPrescriptionBundle:Treatment:index.html.twig', array(
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            $service = $this->getDoctrine()->getRepository('DoctorPrescriptionBundle:DpsService')->findOneBy(array('serviceFormat'=>'treatment'));
            ...
            return $this->redirect($this->generateUrl('dps_treatment', array('id' => $entity->getId())));
        }
    ...
    private function createCreateForm(DmsParticular $entity)
    {
        ...
        $form = $this->createForm(new TreatmentType($globalOption), $entity, array(
            'action' => $this->generateUrl('dps_treatment_create', array('id' => $entity->getId())),
            'method' => 'POST',
            'attr' => array(
    ...
    public function editAction($id)
    {
        $em = $this->getDoctrine()->getManager();
        $config = $this->getUser()->getGlobalOption()->getDmsConfig();
        $pagination = $em->getRepository('DoctorPrescriptionBundle:DpsParticular')->getFindDentalServiceParticular($config,array('treatment'));      $entity = $em->getRepository('DoctorPrescriptionBundle:DpsParticular')->find($id);
    ...
    private function createEditForm(DmsParticular $entity)
    {
        $globalOption = $this->getUser()->getGlobalOption();
        $form = $this->createForm(new TreatmentType($globalOption), $entity, array(
            'action' => $this->generateUrl('dps_treatment_update', array('id' => $entity->getId())),
            'method' => 'PUT',
            'attr' => array(
                'class' => 'horizontal-form',
                'novalidate' => 'novalidate',
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('dps_treatment'));
        }
