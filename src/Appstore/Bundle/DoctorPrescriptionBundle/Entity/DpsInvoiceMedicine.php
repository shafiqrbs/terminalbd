 ...
 *
 * @ORM\Table( name = "dps_invoice_medicine")
 * @ORM\Entity(repositoryClass="Appstore\Bundle\DoctorPrescriptionBundle\Repository\DpsInvoiceMedicineRepository")
 */
class DpsInvoiceMedicine
{
    /**
     * @var integer
     *
