...
class PurchaseType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('dmsVendor', 'entity', array(
                'required'    => true,
                'class' => 'Appstore\Bundle\DoctorPrescriptionBundle\Entity\DpsVendor',
                ...
                'query_builder' => function(EntityRepository $er){
                    return $er->createQueryBuilder('wt')
                        ...
                        ->andWhere("wt.dmsConfig =".$this->option->getDpsConfig()->getId());
                },
            ))
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Appstore\Bundle\DoctorPrescriptionBundle\Entity\DpsPurchase'
        ));
    }
