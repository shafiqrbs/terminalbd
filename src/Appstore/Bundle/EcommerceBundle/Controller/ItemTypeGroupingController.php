...
class ItemTypeGroupingController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('EcommerceBundle:ItemTypeGrouping')->findAll();
        $entities = $this->paginate($entities);
        return $this->render('EcommerceBundle:ItemTypeGrouping:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            $em->persist($entity);
            $em->flush();
            return $this->redirect($this->generateUrl('ecommerce_grouping_edit',array('id'=>$entity->getInventoryConfig()->getId())));
        }
    ...
    public function editAction($id)
    {
        ...
        return $this->render('EcommerceBundle:ItemTypeGrouping:edit.html.twig', array(
            'entities' => $entities,
    ...
    */
    ...
    {
        $form = $this->createForm(new ItemTypeGroupingType(), $entity, array(
            'action' => $this->generateUrl('ecommerce_grouping_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('ecommerce_grouping_edit', array('id' => $id)));
        }
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('ecommerce_grouping_delete', array('id' => $id)))
            ->setMethod('DELETE')
