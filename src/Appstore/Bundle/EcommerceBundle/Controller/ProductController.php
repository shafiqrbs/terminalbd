...
class ProductController extends Controller
{
	...
	public function createAction(Request $request)
	{
		...
		if ($form->isValid()) {
			...
			return $this->redirect($this->generateUrl('ecommerce_product_edit',array('id'=>$entity->getId())));
		}
	...
	private function createCreateForm(PurchaseVendorItem $entity)
	{
		...
		$form = $this->createForm(new EcommerceProductType($em,$inventoryConfig), $entity, array(
			'action' => $this->generateUrl('ecommerce_product_create'),
			'method' => 'POST',
			'attr' => array(
				'class' => 'action',
	...
	public function editAction(PurchaseVendorItem $entity)
	{
		...
		$inventoryConfig = $this->getUser()->getGlobalOption()->getInventoryConfig();
		return $this->render('EcommerceBundle:Product:'.$twig.'.html.twig', array(
			'entity'        => $entity,
			'inventoryConfig' => $inventoryConfig,
	...
	private function createEditForm(PurchaseVendorItem $entity)
	{
		...
		$form = $this->createForm(new EcommerceProductEditType($em,$inventory), $entity, array(
			'action' => $this->generateUrl('ecommerce_product_update', array('id' => $entity->getId())),
			'method' => 'PUT',
			'attr' => array(
				'class' => 'action',
				'novalidate' => 'novalidate',
	...
	public function updateAction(Request $request, $id)
	{
		...
		if ($editForm->isValid()) {
			...
			return $this->redirect($this->generateUrl('ecommerce_product_edit', array('id' => $id)));
		}
		$ecommerceConfig = $this->getUser()->getGlobalOption()->getEcommerceConfig();
		return $this->render('EcommerceBundle:Product:'.$twig.'.html.twig', array(
			'entity'                => $entity,
	...
	public function addSubProductAction(Request $request, PurchaseVendorItem $entity)
	{
		...
		$subItem = $this->renderView( 'EcommerceBundle:Product:subItem.html.twig', array(
			'entity'           => $entity,
		));
	...
	public function webStatusAction($id)
	{
		...
		return $this->redirect($this->generateUrl('ecommerce_product'));
	}
