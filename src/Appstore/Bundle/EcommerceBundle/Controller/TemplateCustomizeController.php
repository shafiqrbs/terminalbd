...
use Appstore\Bundle\EcommerceBundle\Form\TemplateCustomizeType;
...
class TemplateCustomizeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('EcommerceBundle:TemplateCustomize:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function newAction()
    {
        ...
        return $this->render('EcommerceBundle:TemplateCustomize:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    {
        $form = $this->createForm(new TemplateCustomizeType(), $entity, array(
            'action' => $this->generateUrl('template_update', array('id' => $entity->getGlobalOption()->getId())),
            'method' => 'PUT',
            'attr' => array(
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('template_ecommerce_edit', array('id' => $id)));
        }
    ...
    public function ecommerceUpdateAction(Request $request, $id)
    {
        ...
        return $this->render('EcommerceBundle:TemplateCustomize:ecommerce.html.twig', array(
            'entity'      => $entity,
            'form'   => $editForm->createView(),
        ));
    }
