 ...
 * CustomerConfig
 *
 * @ORM\Table("education_config")
 * @ORM\Entity(repositoryClass="Appstore\Bundle\EducationBundle\Repository\EducationConfigRepository")
 */
class EducationConfig
{
	...
	/**
	 * @ORM\OneToOne(targetEntity="Setting\Bundle\ToolBundle\Entity\GlobalOption", inversedBy="educationConfig")
	 * @ORM\JoinColumn(onDelete="CASCADE")
	 **/
	protected $globalOption;

	/**
	 * @ORM\OneToMany(targetEntity="Appstore\Bundle\EducationBundle\Entity\EducationStudentImport", mappedBy="educationConfig")
	 **/
	private $imports;

	/**
	 * @ORM\OneToMany(targetEntity="Appstore\Bundle\EducationBundle\Entity\EducationParticular", mappedBy="educationConfig")
	 **/
	private $particulars;

	/**
	 * @ORM\OneToMany(targetEntity="Appstore\Bundle\EducationBundle\Entity\EducationParticularType", mappedBy="educationConfig")
	...
	{
		return 'uploads/domain/'.$this->getGlobalOption()->getId().'/education';
	}
