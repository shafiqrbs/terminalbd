...
/**
 * ElectionMemberImporter
 *
 * @ORM\Table(name ="election_member_import")
 * @ORM\Entity(repositoryClass="")
 */
class ElectionMemberImport
{
    /**
     * @var integer
     *
     ...
     * @var string
     *
     * @ORM\Column(name="voterType", type="string", length=20, nullable=true)
     */
    private $voterType;
     ...
     * Sets file.
     *
     * @param ElectionMemberImport $file
     */
