 ...
 *
 * @ORM\Table( name = "hotel_temporary_invoice")
 * @ORM\Entity(repositoryClass="Appstore\Bundle\HotelBundle\Repository\HotelTemporaryInvoiceRepository")
 */
class HotelTemporaryInvoice
{
    /**
     * @var integer
     *
