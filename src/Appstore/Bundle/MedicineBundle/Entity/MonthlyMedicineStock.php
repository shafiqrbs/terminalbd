 ...
 * MedicineBrand
 *
 * @ORM\Table("monthly_medicine_stock")
 * @ORM\Entity(repositoryClass="Appstore\Bundle\MedicineBundle\Repository\MonthlyMedicineStockRepository")
 */
class MonthlyMedicineStock
{
    /**
     * @var integer
     *
