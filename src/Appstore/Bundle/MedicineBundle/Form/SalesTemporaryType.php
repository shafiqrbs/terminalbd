...
class SalesTemporaryType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('discountCalculation','number', array('attr'=>array('class'=>'m-wrap span12 salesInput initialDiscount','placeholder'=>'Add payment discount','data-original-title'=>'Add payment discount','autocomplete'=>'off')))
            ->add('discount','hidden')
            ->add('due','hidden')
