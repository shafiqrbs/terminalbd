...
class PurchaseOrderRepository extends EntityRepository
{
    ...
    public  function purchaseSimpleUpdate(PurchaseOrder $purchase){
        ...
        $qb->addSelect('SUM(pvi.estimateSubTotal) AS estimateSubTotal');
        ...
        $purchase->setEstimateTotal($row['estimateSubTotal']);
        $purchase->setTotalAmount($row['total']);
        $purchase->setGrandTotal($row['total']);
