 ...
 * HmsReverse
 *
 * @ORM\Table(name="restaurant_reverse")
 * @ORM\Entity(repositoryClass="Appstore\Bundle\RestaurantBundle\Repository\ReverseRepository")
 */
class Reverse
{
    /**
    ...
    /**
     * @ORM\OneToOne(targetEntity="Appstore\Bundle\RestaurantBundle\Entity\Invoice", inversedBy="reverse")
