...
use Appstore\Bundle\TallyBundle\Form\TaxTariffType;
...
class TaxTariffController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $data = $_REQUEST;
        $entities = $em->getRepository('TallyBundle:TaxTariff')->findWidthSearch($data);
        $pagination = $this->paginate($entities);
        return $this->render('TallyBundle:TaxTariff:index.html.twig', array(
