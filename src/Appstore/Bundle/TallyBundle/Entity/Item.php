 ...
 * Product
 *
 * @ORM\Table("tally_item")
 * @ORM\Entity(repositoryClass="Appstore\Bundle\TallyBundle\Repository\ItemRepository")
 */
class Item
{
    /**
    ...
    /**
	 * @ORM\ManyToOne(targetEntity="Appstore\Bundle\TallyBundle\Entity\TaxTariff", inversedBy="items" )
	 **/
	private  $vatProduct;
	...
	/**
	 * @ORM\ManyToOne(targetEntity="Appstore\Bundle\TallyBundle\Entity\Brand", inversedBy="items" )
	 **/
	private  $brand;
    ...
    /**
     * @return \Appstore\Bundle\TallyBundle\Entity\PurchaseItem
     */
