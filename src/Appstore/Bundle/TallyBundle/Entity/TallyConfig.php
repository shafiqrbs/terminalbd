 ...
 * TallyConfig
 *
 * @ORM\Table( name ="tally_config")
 * @ORM\Entity(repositoryClass="Appstore\Bundle\TallyBundle\Repository\TallyConfigRepository")
 */
class TallyConfig
{
    /**
    ...
    /**
     * @ORM\OneToOne(targetEntity="Setting\Bundle\ToolBundle\Entity\GlobalOption", inversedBy="tallyConfig" , cascade={"persist", "remove"})
    ...
    /**
     * @ORM\OneToMany(targetEntity="Appstore\Bundle\TallyBundle\Entity\StockItem", mappedBy="config" , cascade={"persist", "remove"})
     **/
    private $stockItems;
    ...
    /**
     * @ORM\OneToMany(targetEntity="Appstore\Bundle\TallyBundle\Entity\Brand", mappedBy="config" , cascade={"persist", "remove"})
     **/
    private $brands;
    ...
    /**
     * @ORM\OneToMany(targetEntity="Appstore\Bundle\TallyBundle\Entity\PurchaseItem", mappedBy="config" , cascade={"persist", "remove"})
     **/
    private $purchaseItem;


     /**
     * @ORM\OneToMany(targetEntity="Appstore\Bundle\TallyBundle\Entity\Category", mappedBy="config" , cascade={"persist", "remove"})
     **/
    private $categories;


    /**
     * @ORM\OneToMany(targetEntity="Appstore\Bundle\TallyBundle\Entity\Damage", mappedBy="config" , cascade={"persist", "remove"})
     **/
    private $damages;
