 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="Setting\Bundle\ContentBundle\Repository\TestimonialRepository")
 */
class Testimonial
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Setting\Bundle\ToolBundle\Entity\GlobalOption", inversedBy="testimonials")
     **/
    ...
    {
        return 'uploads/domain/'.$this->getUser()->getGlobalOption()->getId().'/content';
    }
