 ...
 * @ORM\Entity(repositoryClass="Setting\Bundle\ToolBundle\Repository\ThemeRepository")
 */
class Theme
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity="Setting\Bundle\ToolBundle\Entity\SiteSetting", mappedBy="theme")
     **/
    ...
    /**
     * @ORM\ManyToMany(targetEntity="Setting\Bundle\ToolBundle\Entity\Syndicate", inversedBy="themes")
     **/
